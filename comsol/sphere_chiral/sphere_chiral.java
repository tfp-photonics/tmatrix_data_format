...
public class sphere_chiral {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
        .set("relpermittivity", new String[] {"1.44", "0", "0", "0", "1.44", "0", "0", "0", "1.44"});
    ...
    model.component("comp1").material("mat1").propertyGroup("pg1").set("kappa", "0.1");
    ...
    model.component("comp1").material("mat2").propertyGroup("def")
        .set("relpermittivity", new String[] {"1.68-0.26i", "0", "0", "0", "1.68-0.26i", "0", "0", "0", "1.68-0.26i"});
    model.component("comp1").material("mat2").propertyGroup("def").set("relpermittivity_symmetry", "0");
    model.component("comp1").material("mat2").propertyGroup("def")
        .set("relpermeability", new String[] {"1.2-0.22i", "0", "0", "0", "1.2-0.22i", "0", "0", "0", "1.2-0.22i"});
    ...
    model.component("comp1").material("mat2").propertyGroup("pg1").set("kappa", "0.1+0.1i");
